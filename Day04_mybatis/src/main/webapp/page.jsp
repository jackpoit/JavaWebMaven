                          ...
                          <div class="col-md-10 col-md-offset-1">
                              <form class="form-horizontal" action="add" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" id="add_tno" name="tno" required pattern="WNSH[0-9]{4}" title="格式如下：WNSH0001">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" id="add_salary" name="salary" required pattern="[1-9]\d*" title="薪资必须是数字">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="add_managerId" class="col-sm-3 control-label">直属领导</label>
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" id="add_managerId" name="managerId" required pattern="([1-9]\d*)|(BOSS)" title="格式错误">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="add_deptId" class="col-sm-3 control-label">部门代号</label>
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" id="add_deptId" name="deptId" required pattern="([1-9]\d*)|(\u8f6e\u5c97)" title="格式错误">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-sm-offset-3 col-sm-9">
      ...
      <div class="modal fade" tabindex="-1" id="uploadModal">
          <div class="modal-dialog" style="width: 400px">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <div class="row">
                          <form action="upload" method="post" enctype="multipart/form-data" class="form-horizontal" id="uploadForm">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <div id="showImg" class="col-md-6 col-md-offset-4" style="width: 150px;height: 150px;"></div>
                              </div>
